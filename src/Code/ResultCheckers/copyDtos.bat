...
xcopy Dtos\*.cs "..\..\Ark.ResultCheckers.Dtos\Auto" /s /e /exclude:copyit-xlist.txt
rem xcopy Data\*.cs "..\..\..\ResultCheckers\BlazorApp\Data\Auto" /s /e /exclude:copyit-xlist.txt
rem xcopy DataServices\*.cs "..\..\..\ResultCheckers\BlazorApp\Data\Services\Auto" /s /e /exclude:copyit-xlist.txt
rem xcopy Blazor\*.razor "..\..\..\ResultCheckers\BlazorApp\Components\Auto" /s /e /exclude:copyit-xlist.txt
