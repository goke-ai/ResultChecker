...
rem xcopy Data\*.cs "..\..\Ark.ResultCheckers.Data\Auto" /s /e /exclude:copyit-xlist.txt
rem xcopy DataServices\*.cs "..\..\Ark.ResultCheckers.Data\Services\Auto" /s /e /exclude:copyit-xlist.txt
rem xcopy BlazorService\*.razor "..\..\..\ResultCheckers\BlazorApp\Components\Auto" /s /e /exclude:copyit-xlist.txt
