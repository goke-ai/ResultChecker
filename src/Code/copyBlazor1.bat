...
xcopy Blazor1\*.razor "..\..\ResultCheckers\Client\Components" /s /e /exclude:copyit-xlist.txt
xcopy Blazor1\*.cs "..\..\ResultCheckers\Client\Components" /s /e /exclude:copyit-xlist.txt
